...
(cd repos/kube-prometheus/; git pull)
...
kubectl create -f repos/kube-prometheus/manifests/setup
kubectl create -f repos/kube-prometheus/manifests/

# Default / Kubernetes / Compute Resources / Cluster
